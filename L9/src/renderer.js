...
export class Renderer {
    constructor(game, context) {
        ...
        this.playerColor = shapeColors[Math.floor(Math.random() * shapeColors.length)];
    }
    ...
    updateScores() {
        ...
        let scoresDisplay = document.querySelector(`p[data-score-id="${this.game.getGameId()}"]`);
        scoresDisplay.innerText = `Score : ${this.game.getTotalScores().get(1)}`
    }
}